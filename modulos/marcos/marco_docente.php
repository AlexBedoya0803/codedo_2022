...
<head>
<?php require_once('marco_docente_c.php');?>
...
<table width="100%" border="1">
  <tr>
    <td width="16%" valign="top"><p align="center"><span class="Arial_12_B"><img src="../../imagenes/docente.png" width="105" height="99" /></span></p>
      <p align="center">
      ...
      <tr>
        <td style="background-color:#0A351C"><a href="../administracion/docentes/Informacion2.php" target="contenido2">Realizar Solicitud</a></td>
      </tr>
      <tr>
    ...
    <td width="84%" height="580" valign="top"><iframe src="../administracion/docentes/Informacion2.php" name="contenido2" width="100%" height="580" scrolling="Auto" frameborder="0" id="contenido2"><a href="../contenido"></a></iframe></td>
  </tr>
</table>
</body>
</html>