...
<table width="100%" border="1">
  <tr>
    ...
    <td width="84%" height="580" valign="top"><iframe src="../administracion/unidadAcademica/listaSinAvalar.php" name="contenido2" width="100%" height="580" scrolling="Auto" frameborder="0" id="contenido2"><a href="../contenido"></a></iframe></td>
  </tr>
</table>
</body>
</html>
