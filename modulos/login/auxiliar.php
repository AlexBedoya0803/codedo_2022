...
<?php require_once('auxiliar_c.php');
	require_once('Session.php');
	$session;
    $session = Session::getInstance();
    if ($session->getVal("usuario_id")!=null){
...
<table width="100%" border="0">
  <tr>
    <td width="14%" valign="top" bgcolor="#E2EAF1"><p align="center" class="Arial_12_B"><img src="../../imagenes/auxiliar.png" width="100" height="100" /></p>
      <p align="center" class="Arial_12_B Estilo1">Administrador</p>
