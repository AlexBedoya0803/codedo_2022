...
<?php require_once('solicitudResolucion_c.php');?>
<style type="text/css">
<!--
body {
...
<table width="100%" border="0" align="center">
	...
	<tr><td width="172" bgcolor="#527497">
    	...
    	<?php foreach($motivos as $motivo) { if($formulario['motivos']==$motivo->getId()) {?>
	...
	<tr><td bgcolor="#527497">
    	...
    	<?php foreach($dedicaciones as $dedicacion) {  if($formulario['dedicaciones']==$dedicacion->getId()) {?>
    ...
    <tr><td width="172" bgcolor="#527497">
		...
		<?php foreach($facultades as $facultad) {if($formulario['facultades']==$facultad->getId()){ ?>
	...
	<tr><td bgcolor="#527497">
    	...
    	<input name="objetivo" type="text" id="objetivo" value="<?php echo $formulario['objetivo'] ?>"  size="100" readonly/>
    </td></tr>
	<tr><td bgcolor="#527497">
    	<span class="Estilo8">Lugar</span>
    </td><td bgcolor="#FFFFFF">
    	<input name="lugar" type="text" id="lugar" value="<?php echo $formulario['lugar'] ?>" size="100"readonly />
    </td></tr>
	<tr><td bgcolor="#527497">
    	<span class="Estilo8">Fecha de inicio:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="text" name="fecha1" id="fecha1" value="<?php echo $formulario['fecha1'] ?>"readonly/>
    </td></tr>
	<tr><td bgcolor="#527497">
    	<span class="Estilo8">Fecha de terminaci&oacute;n:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="text" name="fecha2" id="fecha2" value="<?php echo $formulario['fecha2'] ?>"readonly/>
    </td></tr>
    <tr>
      <td bgcolor="#527497"><span class="Estilo8">Acta consejo de facultad:</span></td>
      <td bgcolor="#FFFFFF"><input type="text" name="actaCF" id="actaCF" value="<?php echo $formulario['numeroActaCF'] ?>"readonly/></td>
    </tr>
    <tr>
      <td bgcolor="#527497"><span class="Estilo8">Fecha del Acta:</span></td>
      <td bgcolor="#FFFFFF"><input type="text" name="fechaActaCF" id="fechaActaCF" value="<?php echo $formulario['fechaActaCF'] ?>"readonly/></td>
    </tr>
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">Aval Consejo de Facultad:</span>
    </td><td bgcolor="#FFFFFF">
    	<input name="avalCF" type="checkbox" id="avalCF" <?php if(@$solicitud->getAvalCF()) echo ' checked="checked"'; ?>onclick="return false;"/>
    </td></tr>
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">Solicitud de Docente:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="checkbox" name="solicitudProfesor" id="solicitudProfesor" <?php if(@$solicitud->getSolicitudProfesor()) echo ' checked="checked"'; ?>onclick="return false;"/>
    </td></tr>
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">Carta Aceptaci&oacute;n:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="checkbox" name="cartaAceptacion" id="cartaAceptacion" <?php if(@$solicitud->getCartaAceptacion()) echo ' checked="checked"'; ?>onclick="return false;"/>
    </td></tr>    
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">Informe Estudiante:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="checkbox" name="informeEstudiante" id="informeEstudiante" <?php if(@$solicitud->getInformeEstudiante()) echo ' checked="checked"'; ?>onclick="return false;"/>
    </td></tr>  
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">Informe Tutor:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="checkbox" name="informeTutor" id="informeTutor" <?php if(@$solicitud->getInformeTutor()) echo ' checked="checked"'; ?>onclick="return false;"/>
    </td></tr> 
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">Calificaciones:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="checkbox" name="calificaciones" id="calificaciones" <?php if(@$solicitud->getCalificaciones()) echo ' checked="checked"'; ?>onclick="return false;"/>
    </td></tr> 
    ...
    <tr><td width="168" bgcolor="#527497">
    	...
    	<textarea name="comentarios" cols="50" id="comentarios" readonly><?php echo $formulario['comentarios'] ?></textarea>
    </td></tr>     
    <tr><td width="168" bgcolor="#527497">
    	<span class="Estilo8">Observaciones:</span>
    </td><td width="642" bgcolor="#FFFFFF">
    	<textarea name="observaciones" cols="50" id="observaciones" readonly><?php echo $formulario['observaciones'] ?></textarea>
    </td></tr>
