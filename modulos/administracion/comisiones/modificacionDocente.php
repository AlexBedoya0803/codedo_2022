...
<?php require_once('modificacionDocente_c.php');
...
<table width="100%" border="0" align="center">
	...
	<tr><td bgcolor="#527497">
	  <span class="Estilo8">*Objetivo:</span>
	    ...
	    <input name="objetivo" type="text" id="objetivo" value="<?php echo $formulario['objetivo'] ?>" size="100" required/>
      </td></tr>
	<tr><td bgcolor="#527497">
    	<span class="Estilo8">*Lugar</span>
    </td><td bgcolor="#FFFFFF">
    	<input name="lugar" type="text" id="lugar" value="<?php echo $formulario['lugar'] ?>" size="100" required/>
    </td></tr>
	...
	<tr><td bgcolor="#527497">
    	...
    	<input type="text" name="fecha1" id="fecha1" value="<?php echo $formulario['fecha1'] ?>" required/>
    </td></tr>
	<tr><td bgcolor="#527497">
    	<span class="Estilo8">*Fecha de terminaci&oacute;n:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="text" name="fecha2" id="fecha2" value="<?php echo $formulario['fecha2'] ?>" required/>
    </td></tr>
    <!--
    <tr>
    ...
    <tr><td bgcolor="#527497">
    	...
    	<input name="avalCF" type="file" id="avalCF" required/>
    </td></tr>-->
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">*Solicitud de Docente:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="file" name="solicitudProfesor" id="solicitudProfesor" required/>
    </td></tr>
    
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">*Motivaci&oacute;n:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="file" name="motivacion" id="motivacion" required/>
    </td></tr>
    ...
    <tr><td width="178" bgcolor="#527497">
     ...
     <tr><td width="178" colspan="2">
        <div align="center">
        <input name="modificar" type="button" class="button" id="modificar" onclick="enviar('solicitudProfesor,motivacion')" value="Guardar solicitud" />
        </div>
    </td></tr>
    
    <tr><td width="178" colspan="2">
        <div align="center">
        <input style="display:none" name="modificar" type="submit" class="button" id="guardar" onclick="validar_extension( 'file','errorFile,motivacion')" value="Guardar solicitud" />
        </div>
    </td></tr>
    <?php } ?>
</table>
