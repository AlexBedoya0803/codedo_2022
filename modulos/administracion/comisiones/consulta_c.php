...
if( isset($_POST["consulta_proximas_vencer"])) {
	if(isset($_POST['fecha1'])&&isset($_POST['fecha2'])){
		$query = 	"SELECT * FROM `comisiones` WHERE (fechaf BETWEEN '".$_POST['fecha1']."' and '".$_POST['fecha2']."') and 
		(estado_id not in (11, 12, 13, 14, 15, 16))	";
		$session->setVal("query_comisiones",$query);
		$session->setVal("boton",1);	
	}
}
?>