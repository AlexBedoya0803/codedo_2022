          		...
          		<legend ><span class="Estilo10"><?php echo $tipoSolicitud?></span></legend>
                        <table>
                        	<?php if($cantidadSolicitudesRegistradas==0 || !in_array($tipoSolicitud, $tipoSolicitudesRegistradas)){
                                ...
                                <p  class="Informacion">Actualmente tiene una solicitud de este tipo en espera de aval.<br> Puede realizar una modificaci�n de esta o eliminarla.</p>
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
                                  <tr>
                                    ...
                                    <td width="63" bgcolor="#0A351C" class="Estilo8">N�mero</td>
