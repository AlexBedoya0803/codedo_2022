...
<?php 
	require_once('prorrogaDocente_c.php');
...
<table width="100%" border="0" align="center">
	...
	<tr><td bgcolor="#527497">
    	...
    	<input type="text" name="fecha1" id="fecha1" value="<?php echo $formulario['fechaf'] ?>" required/>
    </td></tr>
    
	<tr><td bgcolor="#527497">
    	<span class="Estilo8">*Fecha de terminaci&oacute;n:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="text" name="fecha2" id="fecha2" value="<?php echo $fechaf2 ?>" required/>
    </td></tr>
    <!--
    <tr>
    ...
    <tr><td bgcolor="#527497">
    	...
    	<input type="file" name="cartaAceptacion" id="cartaAceptacion" required/>
    </td></tr>    
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">*Informe de Actividades:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="file" name="informeEstudiante" id="informeEstudiante" required/>
    </td></tr>  
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">*Informe Tutor:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="file" name="informeTutor" id="informeTutor" required/>
    </td></tr> 
    <tr>
    <td bgcolor="#527497">
    	<span class="Estilo8">*Calificaciones:</span>
    </td><td bgcolor="#FFFFFF">
    	<input type="file" name="calificaciones" id="calificaciones" required/>
    </td></tr> 
    ...
    <tr><td width="63%" colspan="2">
        <div align="center">
        <input name="prorrogar" type="button" class="button" id="prorrogar" onclick="enviar('solicitudProfesor,cartaAceptacion,informeEstudiante,calificaciones')" value="Guardar solicitud" />
        </div>
    </td></tr>
