<?php
	class MsgNotificacion{
		static function getMsgNotificacion($name,$msg,$fAceptar,$fCancelar){
			echo'
				<style>
					.modal {
  					...
  					<div class="modal-content">
    					...
    					<div class="modal-body">
      						<form id="addSexo" method="post" name="addSexo" action="AddSexo.php">
      							...
      							<tr>
									<center>
								  		<input name="continuar" type="button" id="continuar" value="Continuar" onClick="" />
										<input name="cancelar" type="button" id="cancelar" value="Cancelar" onClick="cerrar()" />
									</center>
      							</tr>
      						</form>
    					</div>
