...
<title>Informe</title>
<?php require_once('informe_c.php');?>
<style type="text/css">
<!--
body {
...
<script>
	...
	$(function() {$( "#fechaReingreso" ).datepicker();});
...
<legend ><span class="Estilo3">Informe</span></legend>
<table width="100%" border="0" align="center">
	...
	<tr><td bgcolor="#527497">
    	...
    	<?php echo $formulario['fecha1'] ?>
    </td></tr>
    
	<tr><td bgcolor="#527497">
    	<span class="Estilo8">Fecha de terminaci&oacute;n:</span>
    </td><td bgcolor="#FFFFFF">
    	<?php echo $formulario['fecha2'] ?>
    </td></tr>
    <tr><td bgcolor="#527497">
    	<span class="Estilo8">Fecha de ultima actualización </span>
    </td><td bgcolor="#FFFFFF">
    	<?php echo $formulario['fechaf'] ?>
    </td></tr>
    <tr>
    ...
    <tr>
      <td height="46" bgcolor="#527497"><span class="Estilo8">Detalle del Informe:</span></td>
      <td bgcolor="#FFFFFF"><textarea name="detalle" cols="50" id="detalle"></textarea></td>
      </tr>
    <tr>
      <td bgcolor="#527497"><span class="Estilo8">Fecha de Reingreso:</span></td>
      <td bgcolor="#FFFFFF"><input type="text" name="fechaReingreso" id="fechaReingreso"/></td>
    </tr>
    <tr>
      <td bgcolor="#527497"><span class="Estilo8">Obtuvo titulo:</span></td>
      <td bgcolor="#FFFFFF"><input type="checkbox" name="obtuvoTitulo" id="obtuvoTitulo"/></td>
      </tr>
       ...
       <tr>
        ...
        <div align="center">
        <input  name="guardar" type="button" class="button" id="guardar2" onclick="enviar()" value="Guardar solicitud" />
        </div>
    </td></tr>    
    <tr><td width="178" colspan="2">
        <div align="center">
        <input style="display:none" name="guardar" type="submit" class="button" id="guardar" onclick="validar_extension( 'file','errorFile')" value="Guardar solicitud" />
        </div>
    </td></tr>
    <?php } ?>
</table>
