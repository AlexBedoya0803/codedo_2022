...
<?php require_once('consulta1_c.php');?>
...
<body>
<div align="center">
  <p align="center">Solicitudes Por Evaluar</p>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
    <tr>
      <td width="77" style="background-color:#0A351C"><div align="left"><span class="Estilo1">Link</span></div></td>
      <td width="56" style="background-color:#0A351C"><a href="../../auxiliar/costos/nuevo.php">#</a></td>
      <td width="96" style="background-color:#0A351C"><span class="Estilo1">Tipo</span></td>
      <td width="167" style="background-color:#0A351C"><div align="left"><span class="Estilo1">Facultad</span></div></td>
      <td width="228" bordercolor="#ECECFF" style="background-color:#0A351C"><div align="left"><span class="Estilo1">Nombre</span></div></td>
      <td width="147" bordercolor="#ECECFF" style="background-color:#0A351C" class="Estilo1"><div align="left">Cedula</div></td>
    </tr>
    <tr>
  ...
  foreach ($solicitudes as $solicitud)
 {
    ...
    <tr bgcolor="<?php echo $color ?>">						  
      <td height="18"><div align="left"><span class="Estilo2">
      <a href="ver.php?id=<?php echo $solicitud->getId()?>"><img src="../../../imagenes/acciones/Spotlight.png" width="16" height="16" border="0" title="Ver solicitud"/></a> </span>
      <a href="../edicion/solicitud.php?id=<?php echo $solicitud->getId()?>"><img src="../../../imagenes/acciones/Pencil.png" width="16" height="16" border="0" title="Editar la solicitud"/></a>
       <a href="../comisiones/borrarSolicitud.php?id=<?php echo $solicitud->getId()?>"><img src="../../../imagenes/acciones/Delete.png" width="16" height="16" border="0" title="Eliminar la solicitud"/></a> </span>
       <!--<a href="./avalar.php?id=<?php echo $solicitud->getId()?>">
    	<img src="../../../imagenes/iconos/help.png" width="16" height="16" border="0" title="Avalar"/></a>
      </a>-->
      </div>        
